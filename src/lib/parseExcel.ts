...
export function getDefaultWarehouse(): ProjectData {
  return {
    ...
    milestones: [
      ...
      { name: 'Landlord Refurb Design Approved', targetDate: new Date('2024-11-01'), statusPercent: 100, complete: true, actualDate: new Date('2024-10-28'), notes: '' },
      { name: 'Warehouse Refurb', targetDate: new Date('2025-08-01'), statusPercent: 15, complete: false, actualDate: null, notes: 'Started 4 Nov 2024 - landlord managing refurbishment (4 weeks in)' },
      { name: 'Internal Fit-out Planning', targetDate: new Date('2025-09-01'), statusPercent: 0, complete: false, actualDate: null, notes: 'Racking layout design - begins as refurb nears completion' },
      { name: 'Racking & Storage Installed', targetDate: new Date('2025-11-15'), statusPercent: 0, complete: false, actualDate: null, notes: '' },
