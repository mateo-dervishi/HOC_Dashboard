...
export function getDefaultWarehouse(): ProjectData {
  return {
    ...
    daysRemaining: getDaysRemaining(new Date('2026-07-15')),
    milestones: [
      ...
      { name: 'Landlord Refurb Design Approved', targetDate: new Date('2025-09-01'), statusPercent: 100, complete: true, actualDate: new Date('2025-08-25'), notes: '' },
      { name: 'Warehouse Refurb', targetDate: new Date('2026-04-01'), statusPercent: 15, complete: false, actualDate: null, notes: 'Started 4 Nov 2025 - landlord managing refurbishment (4 weeks in)' },
      { name: 'Internal Fit-out Planning', targetDate: new Date('2026-05-01'), statusPercent: 0, complete: false, actualDate: null, notes: 'Racking layout design - begins as refurb nears completion' },
      { name: 'Racking & Storage Installed', targetDate: new Date('2026-06-15'), statusPercent: 0, complete: false, actualDate: null, notes: '' },
      { name: 'Warehouse Operational', targetDate: new Date('2026-07-15'), statusPercent: 0, complete: false, actualDate: null, notes: '' },
    ],
