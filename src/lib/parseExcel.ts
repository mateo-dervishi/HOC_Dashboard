...
export function getDefaultRisks(): RisksData {
  const items: Risk[] = [
    {
      id: 'R001',
      name: 'Showroom 1st Fix Delay',
      rag: 'Amber',
      description: 'Current standstill on 1st fix works',
      mitigation: 'Monitoring closely - expected to resume shortly',
      status: 'Open',
      owner: 'Project Lead',
      isBlocker: false,
    ...
    {
      id: 'R002',
      name: 'Warehouse Handover Timing',
      rag: 'Green',
      description: 'Landlord confirmed Dec 19th handover',
      mitigation: 'Date confirmed - preparing for handover',
      status: 'Open',
      owner: 'Operations',
      isBlocker: false,
      isPendingDecision: false,
    },
    {
      ...
      rag: 'Green',
      description: 'Large initial payment due Dec 19th',
      mitigation: 'Capital secured and available',
      status: 'Open',
      owner: 'Finance',
      isBlocker: false,
      isPendingDecision: false,
    },
    {
      ...
      rag: 'Green',
      description: 'Need to hire warehouse and showroom staff',
      mitigation: 'Recruitment to begin Q1 2026',
      status: 'Open',
      owner: 'HR',
      isBlocker: false,
      isPendingDecision: false,
